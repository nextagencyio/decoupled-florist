...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Petal & Stem Florist in Portland. Order arrangements, book wedding consultations, or inquire about corporate floral services.',
  keywords: ['Contact Florist', 'Order Flowers', 'Wedding Consultation', 'Portland Florist'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about our arrangements or want to plan your event? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">orders@bloomandpetal.com</p>
                    <p className="text-gray-600">support@bloomandpetal.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 678-9011</p>
